...
<body class="admin">
    ...
    <div id="wrapper">
        ...
        <main id="page-content-wrapper" role="main" class="container-fluid dash">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">Add Operator</a></li>
            </ol>
            <div class="card">
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-8 col-md-offset-2">
                    <div class="driver">
                        ...
                        <form method="post" action="admin-addoperator-process.php" enctype="multipart/form-data">
                            ...
                            <label for="">Jeepney Number</label>
                            <input type="text" name="jeepney_no" class="form-control" required>
                            ...
                            <label for=""></label>
                            <button type="submit" class="btn btn-block btn-primary">Add Operator</button>
                        </form> 
                    </div>
                </div>    
            </div>
    ...
    <script>
        <?php if (isset($_SESSION['jeep_exist'])): ?>
            swal("Error!", "The Jeepney Number already Exist", "error");
            <?php unset($_SESSION['jeep_exist']); ?>
        <?php endif ?>
        ...
        <?php if (isset($_SESSION['add_operator'])): ?>
            swal("Success!", "The operator has been added successfully", "success");
            <?php unset($_SESSION['add_operator']); ?>
        <?php endif ?>
    </script>
</body>
</html>