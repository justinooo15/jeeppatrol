                ...
                <div class="container-fluid">
                    ...
                    <div id="navbar-collapse" class="collapse navbar-collapse">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="headnav"><a href="admin-userprofile.php"><i class="fa fa-users"></i>Management</a></li>
        ...
        <main id="page-content-wrapper" role="main" class="container-fluid dash">
            ...
            <div class="dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <li>
                    <a class="dropdown-item" href="admin-dashboard/admin-dashboard-monthly/january.php">January</a>
                </li>
                <li>
                    <a class="dropdown-item" href="admin-dashboard/admin-dashboard-monthly/febuary.php">February</a>
                </li>
                <li>
                    <a class="dropdown-item" href="admin-dashboard/admin-dashboard-monthly/march.php">March</a>
                </li>
                <li>
                    <a class="dropdown-item" href="admin-dashboard/admin-dashboard-monthly/april.php">April</a>
                </li>
                <li>
                    <a class="dropdown-item" href="admin-dashboard/admin-dashboard-monthly/may.php">May</a>
                </li>
                <li>
                    <a class="dropdown-item" href="admin-dashboard/admin-dashboard-monthly/june.php">June</a>
                </li>
                <li>
                    <a class="dropdown-item" href="admin-dashboard/admin-dashboard-monthly/july.php">July</a>
                </li>
                <li>
                    <a class="dropdown-item" href="admin-dashboard/admin-dashboard-monthly/august.php">August</a>
                </li>
                <li>
                    <a class="dropdown-item" href="admin-dashboard/admin-dashboard-monthly/september.php">September</a>
                </li>
                <li>
                    <a class="dropdown-item" href="admin-dashboard/admin-dashboard-monthly/october.php">October</a>
                </li>
                <li>
                    <a class="dropdown-item" href="admin-dashboard/admin-dashboard-monthly/november.php">November</a>
                </li>
                <li>
                    <a class="dropdown-item" href="admin-dashboard/admin-dashboard-monthly/december.php">December</a>
                </li>
                ...
                <div class="card__body">
                    <div class="card__chart">
                        <div class="card__head">
                            <h1>Overall Violations Commited by Jeepney Drivers in the year 2017</h1>
                        </div>
                    ...
                    <script>
                        ...
                        var myChart = new Chart(ctx, {
                            ...
                            data: {
                                ...
                                datasets: [{
                                    label: 'Number of drivers who violated',
