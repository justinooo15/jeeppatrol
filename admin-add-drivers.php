...
<body class="admin">
    ...
    <div id="wrapper">
        ...
        <main id="page-content-wrapper" role="main" class="container-fluid dash">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">Add Drivers</a></li>
            </ol>
            <div class="card">
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-8 col-md-offset-2">
                    <div class="driver">
                        ...
                        <form method="post" action="add-driver.php" enctype="multipart/form-data">
                            ...
                            <label for=""></label>
                            <button type="submit" class="btn btn-primary form-control">Add Driver</button>
                        </form>
                    </div>
                </div>    
            </div>
    ...
    <script>
        $(function() {
            <?php if (isset($_SESSION['add_driver'])): ?>
              swal("Success!", "The driver has been successfully added.", "success");
              <?php unset($_SESSION['add_driver']) ?>
            <?php endif ?>
        });
    </script>
</body>
