                 ...
                 <script>
                        ...
                        var myChart = new Chart(ctx, {
                            ...
                            data: {
                                ...
                                datasets: [
                                    {label: 'December',
                                    data :[<?=json_encode($smoke12);?>, <?=json_encode($uturn12);?>, <?=json_encode($disrespectful12);?>, <?=json_encode($disobedience12);?>, <?=json_encode($disregarding12);?>, <?=json_encode($liquor12);?>, <?=json_encode($loading12);?>, <?=json_encode($unloading12);?>, <?=json_encode($refusal12);?>, <?=json_encode($identification12);?>, <?=json_encode($fare12);?>, <?=json_encode($uniform12);?>, <?=json_encode($obstruction12);?>, <?=json_encode($charging12);?>, <?=json_encode($over12);?>, <?=json_encode($cutting12);?>, <?=json_encode($cellphone12);?>],
