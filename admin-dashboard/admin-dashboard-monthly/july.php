                 ...
                 <script>
                        ...
                        var myChart = new Chart(ctx, {
                            ...
                            data: {
                                ...
                                datasets: [
                                    {label: 'July',
                                    data :[<?=json_encode($smoke7);?>, <?=json_encode($uturn7);?>, <?=json_encode($disrespectful7);?>, <?=json_encode($disobedience7);?>, <?=json_encode($disregarding7);?>, <?=json_encode($liquor7);?>, <?=json_encode($loading7);?>, <?=json_encode($unloading7);?>, <?=json_encode($refusal7);?>, <?=json_encode($identification7);?>, <?=json_encode($fare7);?>, <?=json_encode($uniform7);?>, <?=json_encode($obstruction7);?>, <?=json_encode($charging7);?>, <?=json_encode($over7);?>, <?=json_encode($cutting7);?>, <?=json_encode($cellphone7);?>],
