                 ...
                 <script>
                        ...
                        var myChart = new Chart(ctx, {
                            ...
                            data: {
                                ...
                                datasets: [
                                    {label: 'February',
                                    data :[<?=json_encode($smoke2);?>, <?=json_encode($uturn2);?>, <?=json_encode($disrespectful2);?>, <?=json_encode($disobedience2);?>, <?=json_encode($disregarding2);?>, <?=json_encode($liquor2);?>, <?=json_encode($loading2);?>, <?=json_encode($unloading2);?>, <?=json_encode($refusal2);?>, <?=json_encode($identification2);?>, <?=json_encode($fare2);?>, <?=json_encode($uniform2);?>, <?=json_encode($obstruction2);?>, <?=json_encode($charging2);?>, <?=json_encode($over2);?>, <?=json_encode($cutting2);?>, <?=json_encode($cellphone2);?>],
