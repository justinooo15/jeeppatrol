                 ...
                 <script>
                        ...
                        var myChart = new Chart(ctx, {
                            ...
                            data: {
                                ...
                                datasets: [
                                    {label: 'August',
                                    data :[<?=json_encode($smoke8);?>, <?=json_encode($uturn8);?>, <?=json_encode($disrespectful8);?>, <?=json_encode($disobedience8);?>, <?=json_encode($disregarding8);?>, <?=json_encode($liquor8);?>, <?=json_encode($loading8);?>, <?=json_encode($unloading8);?>, <?=json_encode($refusal8);?>, <?=json_encode($identification8);?>, <?=json_encode($fare8);?>, <?=json_encode($uniform8);?>, <?=json_encode($obstruction8);?>, <?=json_encode($charging8);?>, <?=json_encode($over8);?>, <?=json_encode($cutting8);?>, <?=json_encode($cellphone8);?>],
