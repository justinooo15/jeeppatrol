                 ...
                 <script>
                        ...
                        var myChart = new Chart(ctx, {
                            ...
                            data: {
                                ...
                                datasets: [
                                    {label: 'June',
                                    data :[<?=json_encode($smoke6);?>, <?=json_encode($uturn6);?>, <?=json_encode($disrespectful6);?>, <?=json_encode($disobedience6);?>, <?=json_encode($disregarding6);?>, <?=json_encode($liquor6);?>, <?=json_encode($loading6);?>, <?=json_encode($unloading6);?>, <?=json_encode($refusal6);?>, <?=json_encode($identification6);?>, <?=json_encode($fare6);?>, <?=json_encode($uniform6);?>, <?=json_encode($obstruction6);?>, <?=json_encode($charging6);?>, <?=json_encode($over6);?>, <?=json_encode($cutting6);?>, <?=json_encode($cellphone6);?>],
