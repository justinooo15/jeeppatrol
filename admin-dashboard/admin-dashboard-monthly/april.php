            ...
            <div class="row">
                ...
                <div class="col-xs-6">
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <li>
                            <a class="dropdown-item" href="/january/discourteous.php">Discourteous disrespectful conduct to passenger.</a>
                        </li>
                        <li>
                 ...
                 <script>
                        ...
                        var myChart = new Chart(ctx, {
                            ...
                            data: {
                                ...
                                datasets: [
                                    {label: 'April',
                                    data :[<?=json_encode($smoke4);?>, <?=json_encode($uturn4);?>, <?=json_encode($disrespectful4);?>, <?=json_encode($disobedience4);?>, <?=json_encode($disregarding4);?>, <?=json_encode($liquor4);?>, <?=json_encode($loading4);?>, <?=json_encode($unloading4);?>, <?=json_encode($refusal4);?>, <?=json_encode($identification4);?>, <?=json_encode($fare4);?>, <?=json_encode($uniform4);?>, <?=json_encode($obstruction4);?>, <?=json_encode($charging4);?>, <?=json_encode($over4);?>, <?=json_encode($cutting4);?>, <?=json_encode($cellphone4);?>],
