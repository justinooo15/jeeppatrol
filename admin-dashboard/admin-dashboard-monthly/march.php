                 ...
                 <script>
                        ...
                        var myChart = new Chart(ctx, {
                            ...
                            data: {
                                ...
                                datasets: [
                                    {label: 'March',
                                    data :[<?=json_encode($smoke3);?>, <?=json_encode($uturn3);?>, <?=json_encode($disrespectful3);?>, <?=json_encode($disobedience3);?>, <?=json_encode($disregarding3);?>, <?=json_encode($liquor3);?>, <?=json_encode($loading3);?>, <?=json_encode($unloading3);?>, <?=json_encode($refusal3);?>, <?=json_encode($identification3);?>, <?=json_encode($fare3);?>, <?=json_encode($uniform3);?>, <?=json_encode($obstruction3);?>, <?=json_encode($charging3);?>, <?=json_encode($over3);?>, <?=json_encode($cutting3);?>, <?=json_encode($cellphone3);?>],
