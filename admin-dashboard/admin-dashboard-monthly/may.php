                 ...
                 <script>
                        ...
                        var myChart = new Chart(ctx, {
                            ...
                            data: {
                                ...
                                datasets: [
                                    {label: 'May',
                                    data :[<?=json_encode($smoke5);?>, <?=json_encode($uturn5);?>, <?=json_encode($disrespectful5);?>, <?=json_encode($disobedience5);?>, <?=json_encode($disregarding5);?>, <?=json_encode($liquor5);?>, <?=json_encode($loading5);?>, <?=json_encode($unloading5);?>, <?=json_encode($refusal5);?>, <?=json_encode($identification5);?>, <?=json_encode($fare5);?>, <?=json_encode($uniform5);?>, <?=json_encode($obstruction5);?>, <?=json_encode($charging5);?>, <?=json_encode($over5);?>, <?=json_encode($cutting5);?>, <?=json_encode($cellphone5);?>],
