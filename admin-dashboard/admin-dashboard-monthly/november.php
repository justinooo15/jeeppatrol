                 ...
                 <script>
                        ...
                        var myChart = new Chart(ctx, {
                            ...
                            data: {
                                ...
                                datasets: [
                                    {label: 'November',
                                    data :[<?=json_encode($smoke11);?>, <?=json_encode($uturn11);?>, <?=json_encode($disrespectful11);?>, <?=json_encode($disobedience11);?>, <?=json_encode($disregarding11);?>, <?=json_encode($liquor11);?>, <?=json_encode($loading11);?>, <?=json_encode($unloading11);?>, <?=json_encode($refusal11);?>, <?=json_encode($identification11);?>, <?=json_encode($fare11);?>, <?=json_encode($uniform11);?>, <?=json_encode($obstruction11);?>, <?=json_encode($charging11);?>, <?=json_encode($over11);?>, <?=json_encode($cutting11);?>, <?=json_encode($cellphone11);?>],
