...
<?php
        $sql = "SELECT post_id,  DATE_FORMAT(date_time, '%M %e %Y') AS 'date', COUNT(*) AS 'smoke' FROM tbl_posts
                WHERE violation LIKE '%Smoking%' AND DATEDIFF('2017-10-01', '2017-10-31')
                GROUP BY date DESC";
        $result = mysql_query($sql) or die('Query failed: ' . mysql_error());
      if ($result) {
        $smoke13 = array();
    ...
    ?>
<?php
        $sql = "SELECT post_id,  DATE_FORMAT(date_time, '%M %e %Y') AS 'date', COUNT(*) AS 'uturn' FROM tbl_posts
                WHERE violation LIKE '%No U Turn%' AND DATEDIFF('2017-10-01', '2017-10-31')
                GROUP BY date DESC";
        $result = mysql_query($sql) or die('Query failed: ' . mysql_error());
      if ($result) {
        $smoke13 = array();
    ...
    ?>
    <?php
        $sql = "SELECT post_id,  DATE_FORMAT(date_time, '%M %e %Y') AS 'date', COUNT(*) AS 'disrespectful' FROM tbl_posts
                WHERE violation LIKE '%Disrespectful conduct to passenger%' AND DATEDIFF('2017-10-01', '2017-10-31')
                GROUP BY date DESC";
        $result = mysql_query($sql) or die('Query failed: ' . mysql_error());
      if ($result) {
        $disrespectful13 = array();
        $date = array();
        while ($row = mysql_fetch_assoc($result)) {
            $disrespectful13[] = $row["disrespectful"];
            $date[] = $row["date"];
        }
    }
    ?> 
     <?php
        $sql = "SELECT post_id,  DATE_FORMAT(date_time, '%M %e %Y') AS 'date', COUNT(*) AS 'disobedience' FROM tbl_posts
                WHERE violation LIKE '%Disobedience to the traffic officer%' AND DATEDIFF('2017-10-01', '2017-10-31')
                GROUP BY date DESC";
        $result = mysql_query($sql) or die('Query failed: ' . mysql_error());
      if ($result) {
        $disobedience13 = array();
        $date = array();
        while ($row = mysql_fetch_assoc($result)) {
            $disobedience13[] = $row["disobedience"];
            $date[] = $row["date"];
        }
    }
    ?> 
    <?php
        $sql = "SELECT post_id,  DATE_FORMAT(date_time, '%M %e %Y') AS 'date', COUNT(*) AS 'disregarding' FROM tbl_posts
                WHERE violation LIKE '%Disregarding traffic sign or signal%' AND DATEDIFF('2017-10-01', '2017-10-31')
                GROUP BY date DESC";
        $result = mysql_query($sql) or die('Query failed: ' . mysql_error());
      if ($result) {
        $disregarding13 = array();
        $date = array();
        while ($row = mysql_fetch_assoc($result)) {
            $disregarding13[] = $row["disregarding"];
            $date[] = $row["date"];
        }
    }
    ?>
    <?php
        $sql = "SELECT post_id,  DATE_FORMAT(date_time, '%M %e %Y') AS 'date', COUNT(*) AS 'liquor' FROM tbl_posts
                WHERE violation LIKE '%Driving under the influence of liquor%' AND DATEDIFF('2017-10-01', '2017-10-31')
                GROUP BY date DESC";
        $result = mysql_query($sql) or die('Query failed: ' . mysql_error());
      if ($result) {
        $liquor13 = array();
    ...
    ?>
    <?php
        $sql = "SELECT post_id,  DATE_FORMAT(date_time, '%M %e %Y') AS 'date', COUNT(*) AS 'loading' FROM tbl_posts
                WHERE violation LIKE '%Loading and unloading at the middle of the street%' AND DATEDIFF('2017-10-01', '2017-10-31')
                GROUP BY date DESC";
        $result = mysql_query($sql) or die('Query failed: ' . mysql_error());
      if ($result) {
        $loading13 = array();
        $date = array();
        while ($row = mysql_fetch_assoc($result)) {
            $loading13[] = $row["loading"];
            $date[] = $row["date"];
        }
    }
    ?>
    <?php
        $sql = "SELECT post_id,  DATE_FORMAT(date_time, '%M %e %Y') AS 'date', COUNT(*) AS 'unloading' FROM tbl_posts
                WHERE violation LIKE '%Loading and unloading at the street corner%' AND DATEDIFF('2017-10-01', '2017-10-31')
                GROUP BY date DESC";
        $result = mysql_query($sql) or die('Query failed: ' . mysql_error());
      if ($result) {
        $unloading13 = array();
        $date = array();
        while ($row = mysql_fetch_assoc($result)) {
            $unloading13[] = $row["unloading"];
            $date[] = $row["date"];
        }
    }
    ?>
    <?php
        $sql = "SELECT post_id,  DATE_FORMAT(date_time, '%M %e %Y') AS 'date', COUNT(*) AS 'refusal' FROM tbl_posts
                WHERE violation LIKE '%Refusal of convey passenger%' AND DATEDIFF('2017-10-01', '2017-10-31')
                GROUP BY date DESC";
        $result = mysql_query($sql) or die('Query failed: ' . mysql_error());
      if ($result) {
        $refusal13 = array();
        $date = array();
        while ($row = mysql_fetch_assoc($result)) {
            $refusal13[] = $row["refusal"];
            $date[] = $row["date"];
        }
    }
    ?>
    <?php
        $sql = "SELECT post_id,  DATE_FORMAT(date_time, '%M %e %Y') AS 'date', COUNT(*) AS 'identification' FROM tbl_posts
                WHERE violation LIKE '%Non wearing of proper current identification card%' AND DATEDIFF('2017-10-01', '2017-10-31')
                GROUP BY date DESC";
        $result = mysql_query($sql) or die('Query failed: ' . mysql_error());
      if ($result) {
        $identification13 = array();
        $date = array();
        while ($row = mysql_fetch_assoc($result)) {
            $identification13[] = $row["identification"];
            $date[] = $row["date"];
        }
    }
    ?>
    <?php
        $sql = "SELECT post_id,  DATE_FORMAT(date_time, '%M %e %Y') AS 'date', COUNT(*) AS 'fare' FROM tbl_posts
                WHERE violation LIKE '%Non posting of current passenger fare%' AND DATEDIFF('2017-10-01', '2017-10-31')
                GROUP BY date DESC";
        $result = mysql_query($sql) or die('Query failed: ' . mysql_error());
      if ($result) {
        $fare13 = array();
    ...
    ?>
    <?php
        $sql = "SELECT post_id,  DATE_FORMAT(date_time, '%M %e %Y') AS 'date', COUNT(*) AS 'uniform' FROM tbl_posts
                WHERE violation LIKE '%No uniform%' AND DATEDIFF('2017-10-01', '2017-10-31')
                GROUP BY date DESC";
        $result = mysql_query($sql) or die('Query failed: ' . mysql_error());
      if ($result) {
        $uniform13 = array();
    ...
    <?php
        $sql = "SELECT post_id,  DATE_FORMAT(date_time, '%M %e %Y') AS 'date', COUNT(*) AS 'obstruction' FROM tbl_posts
                WHERE violation LIKE '%Obstruction to traffic%' AND DATEDIFF('2017-10-01', '2017-10-31')
                GROUP BY date DESC";
        $result = mysql_query($sql) or die('Query failed: ' . mysql_error());
      if ($result) {
        $obstruction13 = array();
    ...
    ?>
    <?php
        $sql = "SELECT post_id,  DATE_FORMAT(date_time, '%M %e %Y') AS 'date', COUNT(*) AS 'charging' FROM tbl_posts
                WHERE violation LIKE '%Over charging of fare%' AND DATEDIFF('2017-10-01', '2017-10-31')
                GROUP BY date DESC";
        $result = mysql_query($sql) or die('Query failed: ' . mysql_error());
      if ($result) {
        $charging13 = array();
        $date = array();
        while ($row = mysql_fetch_assoc($result)) {
            $charging13[] = $row["charging"];
            $date[] = $row["date"];
        }
    }
    ?>
     <?php
        $sql = "SELECT post_id,  DATE_FORMAT(date_time, '%M %e %Y') AS 'date', COUNT(*) AS 'over' FROM tbl_posts
                WHERE violation LIKE '%Over loading%' AND DATEDIFF('2017-10-01', '2017-10-31')
                GROUP BY date DESC";
        $result = mysql_query($sql) or die('Query failed: ' . mysql_error());
      if ($result) {
        $over13 = array();
    ...
    ?>
     <?php
        $sql = "SELECT post_id,  DATE_FORMAT(date_time, '%M %e %Y') AS 'date', COUNT(*) AS 'cutting' FROM tbl_posts
                WHERE violation LIKE '%Trip cutting%' AND DATEDIFF('2017-10-01', '2017-10-31')
                GROUP BY date DESC";
        $result = mysql_query($sql) or die('Query failed: ' . mysql_error());
      if ($result) {
        $cutting13 = array();
        $date = array();
        while ($row = mysql_fetch_assoc($result)) {
            $cutting13[] = $row["cutting"];
            $date[] = $row["date"];
        }
    }
    ?>
    <?php
        $sql = "SELECT post_id,  DATE_FORMAT(date_time, '%M %e %Y') AS 'date', COUNT(*) AS 'cellphone' FROM tbl_posts
                WHERE violation LIKE '%Use cellphone while driving%' AND DATEDIFF('2017-10-01', '2017-10-31')
                GROUP BY date DESC";
        $result = mysql_query($sql) or die('Query failed: ' . mysql_error());
      if ($result) {
        $cellphone13 = array();
                 ...
                 <script>
                        ...
                        var myChart = new Chart(ctx, {
                            ...
                            data: {
                                ...
                                datasets: [
                                    {label: 'October',
                                    data :[<?=json_encode($smoke10);?>, <?=json_encode($uturn10);?>, <?=json_encode($disrespectful10);?>, <?=json_encode($disobedience10);?>, <?=json_encode($disregarding10);?>, <?=json_encode($liquor10);?>, <?=json_encode($loading10);?>, <?=json_encode($unloading10);?>, <?=json_encode($refusal10);?>, <?=json_encode($identification10);?>, <?=json_encode($fare10);?>, <?=json_encode($uniform10);?>, <?=json_encode($obstruction10);?>, <?=json_encode($charging10);?>, <?=json_encode($over10);?>, <?=json_encode($cutting10);?>, <?=json_encode($cellphone10);?>],
