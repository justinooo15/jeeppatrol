                 ...
                 <script>
                        ...
                        var myChart = new Chart(ctx, {
                            ...
                            data: {
                                ...
                                datasets: [
                                    {label: 'September',
                                    data :[<?=json_encode($smoke9);?>, <?=json_encode($uturn9);?>, <?=json_encode($disrespectful9);?>, <?=json_encode($disobedience9);?>, <?=json_encode($disregarding9);?>, <?=json_encode($liquor9);?>, <?=json_encode($loading9);?>, <?=json_encode($unloading9);?>, <?=json_encode($refusal9);?>, <?=json_encode($identification9);?>, <?=json_encode($fare9);?>, <?=json_encode($uniform9);?>, <?=json_encode($obstruction9);?>, <?=json_encode($charging9);?>, <?=json_encode($over9);?>, <?=json_encode($cutting9);?>, <?=json_encode($cellphone9);?>],
